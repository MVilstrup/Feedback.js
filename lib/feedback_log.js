...
var FeedbackLog = function(settings) {
	...
	this.html = {
		...
		// Buttons
		ok 		 	: '<button class="feedback-ok " id="feedback-ok">{{ok}}</button>',
...
FeedbackLog.prototype.updateListener = function(btnID, fn, on) {
	...
	if(typeof button !== "undefined"){
		switch  (btnID) {
			...
			case "feedback-close": case "feedback-cancel":
...
FeedbackLog.prototype.details = function(fn, question) {
...
FeedbackLog.prototype.show = function(question, fn) {
	...
	close.className = "feedback-close";
 	close.setAttribute("id", 'feedback-close');
