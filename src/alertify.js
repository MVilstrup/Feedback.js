	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				positive : "<button class=\"alertify-button alertify-button-pos\" id=\"alertify-pos\">Positive</button>",
				neutral  : "<button class=\"alertify-button alertify-button-neutral\" id=\"alertify-neutral\">Neutral</button>",
				negative : "<button class=\"alertify-button alertify-button-neg\" id=\"alertify-neg\">Negative</button>",
		...
		return {
			...
			feedback : function (message, fn, cssClass) { _alertify.dialog(message, "feedback", fn, "", cssClass); return this; },
